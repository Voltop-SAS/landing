 ...
 * `~/core/business/infrastructure/content/company`.
 */
...
import type { Partner } from '~/core/about/domain/entities/Partner'
import type { Testimonial } from '~/core/about/domain/entities/Testimonial'
import type { Person } from '~/core/about/domain/entities/Person'
