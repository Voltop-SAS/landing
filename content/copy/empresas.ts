...
export const empresas = {
  ...
  selector: {
    ...
    title: { es: "¿Qué describe mejor tu situación?", en: "What best describes your situation?", pt: "O que descreve melhor a sua situação?", } satisfies Localized,
    lead: {
    ...
    benefitsTitle: { es: "Qué incluye", en: "What's included", pt: "O que está incluído", } satisfies Localized,
  },

  capabilities: {
    eyebrow: { es: "Cómo trabajamos", en: "How we work", pt: "Como trabalhamos", } satisfies Localized,
    title: { es: "De principio a fin", en: "End to end", pt: "De ponta a ponta", } satisfies Localized,
    lead: {
  ...
  proof: {
    ...
    title: { es: "Ya está funcionando", en: "It's already working", pt: "Já está funcionando", } satisfies Localized,
    challengeLabel: { es: "El reto", en: "The challenge", pt: "O desafio", } satisfies Localized,
    solutionLabel: { es: "Lo que hicimos", en: "What we did", pt: "O que fizemos", } satisfies Localized,
    seeStation: { es: "Ver la estación", en: "See the station", pt: "Ver a estação", } satisfies Localized,
  },

  contact: {
    eyebrow: { es: "Hablemos", en: "Let's talk", pt: "Vamos conversar", } satisfies Localized,
    title: { es: "Cuéntanos tu caso", en: "Tell us your case", pt: "Conte o seu caso", } satisfies Localized,
    /**
     ...
     */
    nextTitle: { es: "Qué pasa después", en: "What happens next", pt: "O que acontece depois", } satisfies Localized,
    next: [
      {
        step: "01",
        title: { es: "Revisamos tu caso", en: "We review your case", pt: "Analisamos o seu caso", } satisfies Localized,
        body: {
      ...
      {
        step: "02",
        title: { es: "Hablamos del sitio", en: "We talk about the site", pt: "Conversamos sobre o local", } satisfies Localized,
        body: {
      ...
      {
        step: "03",
        title: { es: "Recibes una propuesta", en: "You get a proposal", pt: "Você recebe uma proposta", } satisfies Localized,
        body: {
