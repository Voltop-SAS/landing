...
export const novedades = {
  ...
  filter: {
    label: { es: "Filtrar por tipo", en: "Filter by type", pt: "Filtrar por tipo", } satisfies Localized,
   ...
   */
  provisionalTag: { es: "Fecha provisional", en: "Provisional date", pt: "Data provisória", } satisfies Localized,
  provisionalTagAll: { es: "Fechas provisionales", en: "Provisional dates", pt: "Datas provisórias", } satisfies Localized,
  provisionalNoteAll: {
   ...
   */
  empty: {
    title: { es: "Todavía no hay entradas publicadas", en: "No entries published yet", pt: "Ainda não há entradas publicadas", } satisfies Localized,
    body: {
...
export const novedadesInline = {
  station: {
    title: { es: "Novedades de esta estación", en: "News about this station", pt: "Novidades desta estação", } satisfies Localized,
  },
  city: {
    title: { es: "Novedades de la ciudad", en: "News from this city", pt: "Novidades da cidade", } satisfies Localized,
  },
  home: {
    eyebrow: { es: "Novedades", en: "Newsroom", pt: "Novidades", } satisfies Localized,
    title: { es: "Lo último de la red", en: "Latest from the network", pt: "O mais recente da rede", } satisfies Localized,
    action: { es: "Ver todas las novedades", en: "See all news", pt: "Ver todas as novidades", } satisfies Localized,
  },
};
