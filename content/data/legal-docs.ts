...
const termsSections: LegalSection[] = [
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Somos VOLTOP S.A.S. (en adelante, «VOLTOP» o «la Compañía»), sociedad comercial constituida y existente conforme a las leyes de la República de Colombia, identificada con NIT 901.723.964-6, con domicilio principal en la ciudad de Bogotá D.C., República de Colombia. La operación, administración y dispersión de los valores derivados del servicio es realizada por VOLTOP S.A.S.',
      },
      {
        tipo: 'parrafo',
        texto:
          'En VOLTOP valoramos la comunicación directa y transparente con nuestros Usuarios. Por esta razón hemos definido un conjunto de reglas claras que regulan el acceso, la descarga y el uso de nuestra plataforma tecnológica y de nuestras estaciones de carga, incluyendo nuestra aplicación móvil, nuestro sitio web y las Estaciones de Carga (en conjunto, los «presentes Términos y Condiciones»).',
      },
      {
        tipo: 'parrafo',
        texto:
          'Al ingresar, navegar, registrarse, acceder a la Plataforma o utilizar una Estación de Carga, el Usuario declara que ha leído, comprendido y aceptado estos Términos y Condiciones. Si el Usuario no está de acuerdo con ellos, deberá abstenerse de utilizar la Plataforma y las Estaciones de Carga.',
      },
      {
        tipo: 'parrafo',
        texto:
          'VOLTOP podrá actualizar o modificar estos Términos y Condiciones en cualquier momento, conforme a la cláusula de modificaciones. La versión vigente estará siempre disponible para consulta en el Sitio Web y en la Aplicación.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Para efectos de los presentes Términos y Condiciones, los siguientes términos tendrán el significado que se indica a continuación:',
      },
      {
        tipo: 'parrafo',
        texto:
          'Aplicación: Plataforma móvil de propiedad de VOLTOP, incluyendo su infraestructura, redes, sistemas operativos, bases de datos y software, mediante la cual el Usuario puede consultar y activar Estaciones de Carga, disponible para los sistemas operativos iOS y Android.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Sitio Web: Portal de internet de propiedad de VOLTOP, cuya dirección es https://www.voltop.co, incluyendo sus subdominios, contenidos y funcionalidades.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Plataforma: De manera conjunta, la Aplicación, el Sitio Web y cualquier otro canal digital de VOLTOP a través del cual se presten los Servicios.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Estación de Carga: Equipo o infraestructura de recarga de vehículos eléctricos habilitado por VOLTOP o por sus aliados, cuyo acceso o activación se gestiona a través de la Plataforma.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Sesión de Carga: Operación de suministro de energía a un vehículo eléctrico iniciada y gestionada por el Usuario a través de la Plataforma.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Servicios: Los productos y servicios ofrecidos por VOLTOP, incluyendo, sin limitarse a ello, la consulta y activación de Estaciones de Carga, el suministro de energía a través de estas y los servicios de soporte asociados.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Tarifa: Valor que el Usuario debe pagar por el uso del Servicio, expresado en pesos colombianos, que puede comprender cargos por energía o por sesión, por reserva, por ocupación o permanencia y por servicios adicionales, según se informe previamente.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Saldo: Fondos que el Usuario precarga en la Plataforma, cuando esta funcionalidad esté habilitada, para el pago de las Sesiones de Carga.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Proveedores de Pago: Entidades financieras y proveedores externos de servicios de pago debidamente habilitados que procesan las transacciones del Usuario.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Usuario: Toda persona natural o jurídica que acceda, navegue, se registre o utilice la Plataforma o las Estaciones de Carga.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Usuario Consumidor: Usuario, persona natural o jurídica, que adquiere o utiliza el Servicio para la satisfacción de una necesidad propia, privada, familiar o doméstica, y no ligada intrínsecamente a su actividad económica.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Usuario Empresarial: Usuario que utiliza el Servicio en el marco de su actividad económica, comercial o profesional, incluyendo, entre otros, empresas y operadores de flotas.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Política de Tratamiento de Datos: La Política de Tratamiento de Datos Personales y Aviso de Privacidad de VOLTOP, disponible en el Sitio Web y en la Aplicación, que forma parte integral de estos Términos y Condiciones.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Contenido: Todo texto, imagen, marca, logotipo, diseño, software, base de datos y demás material disponible en la Plataforma.',
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'El Usuario reconoce que la Plataforma constituye una herramienta tecnológica para la gestión del servicio de carga eléctrica, y que su disponibilidad y funcionamiento pueden verse afectados por factores técnicos, de conectividad, de mantenimiento de las Estaciones de Carga o por causas atribuibles a terceros ajenos al control de VOLTOP. VOLTOP podrá modificar, ampliar, restringir, suspender o descontinuar, total o parcialmente, las funcionalidades de la Plataforma y la cobertura geográfica del Servicio, por razones operativas, técnicas, comerciales o de seguridad, procurando informar oportunamente cuando ello afecte de manera sustancial la prestación del Servicio.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Al ingresar a la Plataforma y, cuando corresponda, registrar una cuenta de Usuario, el Usuario acepta de manera expresa, libre, informada e inequívoca los presentes Términos y Condiciones. El Usuario declara contar con la capacidad legal necesaria para obligarse. Los Servicios están disponibles exclusivamente para personas con capacidad legal para contratar; no podrán utilizarlos los menores de edad ni las personas cuya cuenta haya sido suspendida o cancelada por VOLTOP.',
      },
      {
        tipo: 'parrafo',
        texto:
          'El Usuario reconoce expresamente que la aceptación de estos Términos y Condiciones no constituye ni genera contrato de sociedad, mandato, agencia, ni relación laboral, de dependencia o de subordinación de ninguna naturaleza entre VOLTOP y el Usuario. En caso de desacuerdo, el Usuario deberá abstenerse de registrarse y de utilizar el Servicio.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Para utilizar determinados Servicios, el Usuario deberá completar el formulario de registro en la Plataforma, suministrando datos como nombre completo, documento de identificación, correo electrónico y número de teléfono móvil. El Usuario garantiza que la información suministrada es correcta, veraz, completa y actualizada, y se abstiene de proporcionar datos de terceros o de suplantar la identidad de cualquier persona.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Tras el registro, VOLTOP podrá enviar al correo o teléfono móvil del Usuario un código de confirmación. Completado el proceso, el Usuario generará su contraseña, siendo el único responsable de su custodia y confidencialidad. El Usuario acepta que: (i) solo podrá crear una (1) cuenta personal; (ii) notificará de inmediato a VOLTOP cualquier uso no autorizado de su cuenta o credenciales, o cualquier vulneración de seguridad; y (iii) cerrará su sesión al finalizar el uso de la Plataforma.',
      },
      {
        tipo: 'parrafo',
        texto:
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'La carga de vehículos eléctricos implica el manejo de energía de alta potencia. Por la seguridad del Usuario, de terceros y de los equipos, el Usuario se obliga a observar las siguientes reglas y reconoce las siguientes condiciones:',
      },
      {
        tipo: 'lista',
        items: [
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'El Usuario reconoce y acepta que la velocidad de carga y la potencia efectivamente entregada (medida en kW) dependen de factores como el vehículo, su estado de carga, la temperatura ambiente, las condiciones de la red eléctrica y las especificaciones de la Estación de Carga. En consecuencia, VOLTOP no garantiza una velocidad, potencia o tiempo de carga determinados.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Dentro de los límites permitidos por la ley, VOLTOP no será responsable por daños derivados del incumplimiento de las instrucciones de uso y seguridad, del uso indebido de las Estaciones de Carga, de defectos o fallas del vehículo del Usuario, o de la inobservancia de las advertencias señaladas, sin perjuicio de la garantía legal y de la responsabilidad por dolo o culpa grave imputable a VOLTOP.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'La descarga, el registro y el uso de la Plataforma no generan costo alguno para el Usuario. Los cargos únicamente se causarán por el uso del Servicio, conforme a la Tarifa informada y aceptada por el Usuario antes del inicio de cada Sesión de Carga. Las Tarifas se expresan en pesos colombianos (COP) e incluyen o discriminan el impuesto sobre las ventas (IVA) y demás tributos aplicables, conforme a la normativa vigente.',
      },
      {
        tipo: 'parrafo',
        texto:
          'VOLTOP podrá aplicar distintos tipos de cargos, siempre informados de manera previa, incluyendo cargos por energía o por sesión, cargos por reserva, cargos por ocupación o permanencia (cuando el vehículo permanezca conectado tras finalizar la carga) y cargos por servicios adicionales, cuando apliquen.',
      },
      {
        tipo: 'parrafo',
        texto:
          'En caso de interrupciones, fallas técnicas o terminación anticipada de la Sesión de Carga, el cobro se efectuará conforme a la energía efectivamente suministrada, cuando ello sea técnicamente posible, o será objeto de revisión a solicitud del Usuario. Las solicitudes de cobros, reversos, ajustes o aclaraciones deberán presentarse dentro de un plazo máximo de diez (10) días calendario, contados desde la Sesión de Carga o el cobro correspondiente, a través de los canales de atención, sin perjuicio de los derechos que la ley reconoce al Usuario.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Para la gestión de los pagos, la Plataforma utiliza Proveedores de Pago debidamente habilitados, responsables del procesamiento de las transacciones, la validación de los medios de pago y la aplicación de sus propias políticas de seguridad y prevención de fraude. VOLTOP no almacena ni conserva información financiera sensible, como los datos completos de tarjetas de crédito o débito. VOLTOP actúa exclusivamente como facilitador tecnológico del servicio y no es una entidad financiera ni presta servicios bancarios; en consecuencia, no será responsable por rechazos, bloqueos, retenciones, cargos, reversos o validaciones derivados de las políticas o sistemas de las entidades financieras o de los Proveedores de Pago.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Cuando la Plataforma habilite la funcionalidad de Saldo o monedero, el Usuario podrá precargar fondos para el pago de las Sesiones de Carga. Las recargas de Saldo no constituyen depósitos, no devengan intereses ni rendimientos, y no podrán ser utilizadas para fines distintos al pago de los Servicios.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Los reembolsos de Saldo no consumido procederán conforme a la ley y a las condiciones informadas al Usuario al momento de la recarga. VOLTOP podrá establecer una vigencia para el Saldo y condiciones de uso, las cuales serán informadas de manera previa y clara. En ningún caso VOLTOP aplicará cargos o vencimientos que vulneren los derechos que la ley reconoce al Usuario Consumidor.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      { tipo: 'parrafo', texto: 'El Usuario se obliga a:' },
      {
        tipo: 'lista',
        items: [
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'El incumplimiento de estas obligaciones podrá dar lugar a la suspensión o cancelación del acceso del Usuario, sin perjuicio de las demás acciones legales a que haya lugar.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto: 'El Usuario se abstendrá, en todo momento, de:',
      },
      {
        tipo: 'lista',
        items: [
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'VOLTOP no garantiza la disponibilidad continua ni el funcionamiento ininterrumpido de la Plataforma ni de las Estaciones de Carga. Dentro de los límites permitidos por la ley, VOLTOP no asumirá responsabilidad por daños o perjuicios que puedan surgir como consecuencia de:',
      },
      {
        tipo: 'lista',
        items: [
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Estos Términos y Condiciones regulan la prestación de los Servicios entre la Compañía, como prestador, y el Usuario, como destinatario del Servicio. En ningún momento la relación entre las partes podrá considerarse como una relación de dependencia, subordinación, sociedad, mandato o agencia.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El Usuario asume la total responsabilidad por el cumplimiento de las obligaciones fiscales y cargas impositivas que se deriven de las operaciones que realice a través de la Plataforma. VOLTOP no será responsable por el cumplimiento de las obligaciones fiscales a cargo del Usuario, ni por cualquier otra obligación derivada de actividades propias de este.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'VOLTOP podrá modificar estos Términos y Condiciones en cualquier momento, por razones operativas, técnicas, comerciales, de seguridad o por cambios normativos. Las modificaciones que afecten de manera sustancial los derechos u obligaciones del Usuario, incluidas las relacionadas con precios o limitaciones relevantes del servicio, serán notificadas a través de la Plataforma y, cuando corresponda, mediante el correo electrónico registrado, con antelación razonable a su entrada en vigencia. Las modificaciones de carácter operativo, técnico, de seguridad o correctivo podrán entrar en vigor de manera inmediata, previa publicación.',
      },
      {
        tipo: 'parrafo',
        texto:
          'El uso de la Plataforma o de las Estaciones de Carga con posterioridad a la publicación de las modificaciones se entenderá como aceptación de las mismas. En caso de no estar de acuerdo, el Usuario deberá abstenerse de continuar utilizando el Servicio. La versión vigente será la publicada en la Plataforma y sustituirá cualquier versión anterior.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El Usuario no podrá ceder ni transferir, total o parcialmente, sus derechos u obligaciones derivados de estos Términos y Condiciones, ni cualquier reclamación contra VOLTOP, sin la autorización previa y escrita de la Compañía. VOLTOP podrá ceder su posición contractual, derechos u obligaciones a cualquier sociedad de su grupo empresarial o a un tercero, en el marco de operaciones de reorganización empresarial, garantizando los derechos del Usuario.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El Usuario acepta que VOLTOP pueda enviarle comunicaciones y notificaciones relacionadas con el Servicio a través de medios electrónicos, incluyendo el correo electrónico registrado y las notificaciones dentro de la Plataforma, las cuales se entenderán válidas y eficaces.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Para efectos de notificaciones, VOLTOP tiene su domicilio principal en la ciudad de Bogotá D.C., en la dirección Cra. 15 # 80-90, y atenderá comunicaciones a través del correo electrónico soporte@voltop.co.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El Usuario podrá presentar peticiones, quejas, reclamos y sugerencias (PQRS) a través de los canales de atención habilitados en la Plataforma o mediante el correo electrónico soporte@voltop.co. Sin perjuicio de lo anterior, el Usuario que tenga la calidad de consumidor podrá acudir a la Superintendencia de Industria y Comercio (SIC) en ejercicio de los derechos que le reconoce el Estatuto del Consumidor.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'VOLTOP S.A.S. (en adelante, «VOLTOP»), sociedad comercial constituida conforme a las leyes de la República de Colombia, identificada con NIT 901.723.964-6, con domicilio principal en la ciudad de Bogotá D.C., República de Colombia, actúa como Responsable del Tratamiento de los datos personales recolectados a través de la aplicación móvil, el sitio web y las estaciones de carga de VOLTOP (en adelante, la «Plataforma»).',
      },
      {
        tipo: 'parrafo',
        texto:
          'Datos de contacto: Dirección: Cra. 15 # 80-90, Bogotá D.C. Correo electrónico: soporte@voltop.co. Sitio web: https://www.voltop.co.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'Dato sensible: Dato que afecta la intimidad del Titular o cuyo uso indebido puede generar su discriminación, tales como los relacionados con salud, datos biométricos, origen racial o étnico, orientación política, convicciones religiosas u orientación sexual.',
      },
      {
        tipo: 'parrafo',
        texto:
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'Responsable del Tratamiento: VOLTOP S.A.S., quien decide sobre la base de datos y el tratamiento de los datos.',
      },
      {
        tipo: 'parrafo',
        texto: 'Titular: Persona natural cuyos datos personales son objeto de tratamiento.',
      },
      {
        tipo: 'parrafo',
        texto:
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'Transferencia: Envío de datos por el Responsable o Encargado, ubicado en Colombia, a un receptor que es Responsable y se encuentra dentro o fuera del país.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Transmisión: Tratamiento de datos que implica su comunicación a un Encargado, dentro o fuera del territorio nacional, para que realice el tratamiento por cuenta del Responsable.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'A través de la Plataforma, VOLTOP podrá recolectar y tratar los siguientes datos personales:',
      },
      {
        tipo: 'lista',
        items: [
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'VOLTOP no recolecta datos sensibles de manera necesaria para la prestación del servicio. En caso de requerir el tratamiento de algún dato sensible, lo hará únicamente con la autorización previa, expresa e informada del Titular, advirtiéndole que no está obligado a autorizar su tratamiento. El Titular podrá negarse a suministrar datos sensibles sin que ello afecte el acceso a los servicios que no los requieran.',
      },
      {
        tipo: 'parrafo',
        texto:
          'La Plataforma está dirigida a personas mayores de edad con capacidad legal para contratar. VOLTOP no recolecta de manera consciente datos de menores de edad. En caso de identificar que se han recolectado datos de un menor sin la autorización de su representante legal, VOLTOP procederá a su supresión.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto: 'Los datos personales recolectados serán tratados para las siguientes finalidades:',
      },
      {
        tipo: 'lista',
        items: [
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El sitio web y la aplicación de VOLTOP pueden utilizar cookies y tecnologías similares, que se clasifican en las siguientes categorías:',
      },
      {
        tipo: 'lista',
        items: [
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'El Titular puede gestionar o deshabilitar las cookies a través de la configuración de su navegador o dispositivo, o del gestor de consentimiento dispuesto en el sitio web, teniendo en cuenta que ello puede afectar el funcionamiento de algunas funcionalidades.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Para el cumplimiento de las finalidades descritas, VOLTOP podrá compartir, transmitir o transferir datos personales, en lo estrictamente necesario, a las siguientes categorías de destinatarios:',
      },
      {
        tipo: 'lista',
        items: [
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'Estos destinatarios actúan como Encargados del Tratamiento bajo las instrucciones de VOLTOP o como Responsables independientes, según el caso, y están obligados a cumplir niveles de protección equivalentes a los previstos en esta Política y en la normativa aplicable.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Algunos de los destinatarios, Encargados y proveedores de VOLTOP pueden encontrarse fuera del territorio colombiano, por ejemplo, en Estados Unidos, Brasil, Islas Caimán o en los países donde operen los proveedores de servicios tecnológicos y de alojamiento en la nube. En consecuencia, los datos personales podrán ser objeto de transferencia o transmisión internacional para el cumplimiento de las finalidades descritas en esta Política.',
      },
      {
        tipo: 'parrafo',
        texto:
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'Los datos personales serán conservados durante el tiempo necesario para cumplir las finalidades del tratamiento y mientras subsistan las obligaciones legales aplicables, atendiendo, de manera enunciativa, los siguientes criterios:',
      },
      {
        tipo: 'lista',
        items: [
      ...
      },
      {
        tipo: 'parrafo',
        texto:
          'Cumplidas las finalidades y vencidos los plazos legales, los datos serán suprimidos o anonimizados, salvo que su conservación sea exigida por disposición legal.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto: 'El Titular de los datos personales tiene derecho a:',
      },
      {
        tipo: 'lista',
        items: [
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El Titular podrá ejercer sus derechos presentando una consulta o reclamo a través del correo electrónico soporte@voltop.co o de los canales de atención habilitados en la Plataforma, indicando su identificación, la descripción de los hechos y los datos de contacto.',
      },
      {
        tipo: 'parrafo',
        texto:
          'Consultas: serán atendidas en un término máximo de diez (10) días hábiles contados desde su recibo. Cuando no fuere posible atenderla dentro de dicho término, se informará al interesado los motivos de la demora y la fecha en que se atenderá, que no superará los cinco (5) días hábiles siguientes al vencimiento del primer plazo.',
      },
      {
        tipo: 'parrafo',
        texto:
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El área encargada de atender las peticiones, consultas y reclamos relacionados con el tratamiento de datos personales es el área de atención al usuario de VOLTOP, a través del correo electrónico soporte@voltop.co y de los canales dispuestos en la Plataforma.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'VOLTOP cumple con la inscripción de sus bases de datos que contienen datos personales en el Registro Nacional de Bases de Datos (RNBD) administrado por la Superintendencia de Industria y Comercio, en los casos y términos en que ello resulte legalmente exigible.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'La presente Política entra en vigencia a partir de su publicación en la Plataforma. Las bases de datos administradas por VOLTOP tendrán vigencia durante el tiempo necesario para cumplir las finalidades del tratamiento y mientras subsistan las obligaciones legales aplicables.',
      },
    ],
  },
  {
    ...
    body: [
      {
        tipo: 'parrafo',
        texto:
          'El Titular reconoce que ha leído y comprendido la presente Política de Tratamiento de Datos Personales y Aviso de Privacidad, y autoriza de manera libre, previa, expresa e informada el tratamiento de sus datos personales conforme a lo aquí establecido.',
      },
    ],
  },
]
...
export const legalDocs = {
  terms: {
    ...
    actualizadoISO: '2026-05-29',
    secciones: termsSections,
  },
  privacy: {
    titulo: 'POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES Y AVISO DE PRIVACIDAD - VOLTOP',
    actualizado: '29 de mayo de 2026',
    actualizadoISO: '2026-05-29',
    secciones: privacySections,
  },
