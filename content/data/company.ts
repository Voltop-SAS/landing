...
export const metrics: Metric[] = [
  { key: "estaciones", value: null, unit: null, label: { es: "Estaciones en operación", en: "Stations in operation" }, source: null, validated: false, featured: true },
  { key: "ciudades", value: null, unit: null, label: { es: "Ciudades", en: "Cities" }, source: null, validated: false, featured: true },
  { key: "energia", value: null, unit: "MWh", label: { es: "Energía entregada", en: "Energy delivered" }, source: null, validated: false },
  { key: "sesiones", value: null, unit: null, label: { es: "Sesiones de carga", en: "Charging sessions" }, source: null, validated: false },
  { key: "usuarios", value: null, unit: null, label: { es: "Conductores conectados", en: "Connected drivers" }, source: null, validated: false },
  { key: "co2", value: null, unit: "t", label: { es: "CO₂ evitado", en: "CO₂ avoided" }, source: null, validated: false },
];
...
export const businessSegments: BusinessSegment[] = [
  {
    ...
    headline: { es: "Carga para tu sede y tu equipo", en: "Charging for your site and your team" },
    proposition: {
    ...
    benefits: [
      { es: "Instalación y operación de principio a fin", en: "End-to-end installation and operation" },
      { es: "Control de acceso y consumo por colaborador", en: "Per-employee access and usage control" },
      { es: "Reportes de energía y disponibilidad", en: "Energy and availability reporting" },
      { es: "Mantenimiento y soporte incluidos", en: "Maintenance and support included" },
    ],
    proofRef: "universidad-ean",
  },
  {
    key: "flota",
    label: { es: "Flota", en: "Fleet" },
    headline: { es: "Infraestructura para que tu flota no pare", en: "Infrastructure that keeps your fleet moving" },
    proposition: {
    ...
    benefits: [
      { es: "Dimensionamiento según rutas y turnos", en: "Sized around routes and shifts" },
      { es: "Carga programada en horario valle", en: "Scheduled off-peak charging" },
      { es: "Datos de consumo por vehículo", en: "Per-vehicle consumption data" },
      { es: "Acceso a la red pública Voltop", en: "Access to the public Voltop network" },
    ],
  },
  {
    key: "espacio",
    label: { es: "Espacio comercial", en: "Property" },
    headline: { es: "Tu espacio, con carga eléctrica", en: "Your space, with EV charging" },
    proposition: {
    ...
    benefits: [
      { es: "Sin inversión inicial de tu parte", en: "No upfront investment on your side" },
      { es: "Operación y mantenimiento a cargo de Voltop", en: "Operation and maintenance handled by Voltop" },
      { es: "Mayor permanencia y retorno de visitantes", en: "Longer dwell time and repeat visits" },
      { es: "Tu espacio visible en la red Voltop", en: "Your space listed across the Voltop network" },
    ],
    proofRef: "universidad-ean",
  },
  {
    key: "partner",
    label: { es: "Partner", en: "Partner" },
    headline: { es: "Construyamos la red juntos", en: "Let's build the network together" },
    proposition: {
    ...
    benefits: [
      { es: "Integración técnica con la plataforma", en: "Technical platform integration" },
      { es: "Alianzas de expansión territorial", en: "Territorial expansion partnerships" },
      { es: "Acuerdos con fabricantes y operadores", en: "Agreements with manufacturers and operators" },
    ],
  },
];
...
export const cases: Case[] = [
  {
    ...
    role: { es: "Universidad EAN", en: "EAN University" },
...
export const testimonials: Testimonial[] = [
  {
    quote: { es: "La operación de nuestras estaciones ha sido impecable y confiable.", en: "Running our stations has been flawless and reliable." },
    author: "Herbert Perico",
    role: { es: "Universidad EAN", en: "EAN University" },
  ...
  {
    quote: { es: "Cargar mi vehículo cuesta muchísimo menos que la gasolina.", en: "Charging my vehicle costs far less than gasoline." },
    author: "Mario Guzmán",
    role: { es: "Conductor", en: "Driver" },
    organization: null,
    photo: null,
    segment: "b2c",
  },
