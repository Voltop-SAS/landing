  ...
  return (
    <div className={className}>
      <ul className="flex flex-wrap gap-3">
        <li>
          <a href={externalLinks.app} target="_blank" rel="noopener noreferrer" className={insignia}>
            {/* Manzana de Apple */}
            <svg aria-hidden="true" viewBox="0 0 24 24" className="size-6 shrink-0 fill-ink">
        ...
        <li>
          <a href={externalLinks.app} target="_blank" rel="noopener noreferrer" className={insignia}>
            ...
            <svg aria-hidden="true" viewBox="0 0 24 24" className="size-6 shrink-0">
              <path d="M3.6 2.3c-.26.28-.4.7-.4 1.25v16.9c0 .55.14.97.4 1.25l.06.05 9.48-9.47v-.22L3.66 2.6l-.06-.3z" fill="#00D0FF" />
              <path d="m16.3 15.44-3.16-3.16v-.22l3.16-3.16.07.04 3.74 2.13c1.07.6 1.07 1.6 0 2.21l-3.74 2.12-.07.04z" fill="#FFC900" />
              <path d="m16.37 15.4-3.23-3.23-9.54 9.53c.35.37.93.42 1.59.05l11.18-6.35z" fill="#F9423A" />
              <path d="M16.37 8.94 5.19 2.6c-.66-.37-1.24-.32-1.59.05l9.54 9.52 3.23-3.23z" fill="#00E676" />
            </svg>
            <span className={rotulo}>
