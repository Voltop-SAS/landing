  ...
  return (
    <>
      <Section id="casos" space="base" ariaLabelledby="selector-title">
        <Container>
          <SectionHeading id="selector-title" kicker={t(empresas.selector.eyebrow, lang)} measure="max-w-[22ch]">
      ...
      {proofCase && (
        <Section space="base" className="border-t border-line bg-surface-1" ariaLabelledby="evidencia-title">
          <Container>
            <SectionHeading id="evidencia-title" kicker={t(empresas.proof.eyebrow, lang)} kickerTone="brand">
      ...
      <Section id="contacto" space="base" className="border-t border-line" ariaLabelledby="contacto-title">
        <Container>
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
            <div>
              <SectionHeading id="contacto-title" kicker={t(empresas.contact.eyebrow, lang)}>
              ...
              <ol className="mt-6 space-y-0">
                {empresas.contact.next.map((n) => (
                  <li key={n.step} className="border-t border-line py-5">
              ...
              <p className="mt-8 text-caption text-ink-3">{t(empresas.contact.privacyNote, lang)}</p>
            </div>
